...
struct AsyncQueryCancelationToken {
    ...
    AsyncQueryCancelationToken(std::shared_ptr<_impl::AsyncQuery> query, AsyncQueryCallback* callback)
    : m_query(std::move(query)), m_callback(callback) { }
...
private:
    ...
    AsyncQueryCallback* m_callback = nullptr;
};
...
private:
    ...
    SortOrder m_sort;
    std::weak_ptr<_impl::AsyncQuery> m_query_runner;
